...
-- https://nanotipsforvim.prose.sh/better-folding-%28part-3%29--remember-your-folds-across-sessions
...
local fold_au_group = vim.api.nvim_create_augroup('folds', { clear = true })
